...
const ServicesSelector = ({ selectedServices, toggleService, SERVICES, serviceOpen, setServiceOpen }) => {
    return (
        <div className='relative'>
            ...
            >
                {selectedServices?.length <= 0 && <div className='text-[#7F7F7F] md:text-base text-sm'>Ex- Digital Marketing / Software Development</div>}
