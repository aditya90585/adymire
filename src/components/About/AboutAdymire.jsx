    ...
    <section className="bg-[#FFF4D9] py-12 px-2">
      <div className=" mx-10">
        ...
        <div className="flex justify-center gap-16 items-center">
          ...
          <div className="bg-white w-[60%] rounded-3xl p-8 shadow-md border-2 border-[#a8a7a7]">
            <p className="text-gray-700 leading-relaxed text-lg">
              <span className="font-semibold text-black">Adymire</span> is a dynamic, all-in-one platform offering a wide
            ...
            <p className="mt-6 text-right font-semibold text-black">
              -- YashGoswami
            </p>
          </div>

          {/* Image Section */}
          <div className="grid grid-cols-1 grid-rows-1  w-[30%] justify-center items-center relative">
