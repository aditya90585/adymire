...
const CurrentPlanDetailsBox = ({ planId, allPlansData, detailBoxState, setDetailBoxState }) => {
    ...
    return (
        <div data-lenis-prevent
            className="bg-[#d3d3d3] mt-18  lg:mt-18 lg:p-10 p-0 lg:pt-6 pt-0 overflow-y-scroll [&::-webkit-scrollbar]:hidden fixed inset-0 z-40 top-0"
        >
            <div className='p-4 bg-white rounded-none ld:rounded-lg relative'>
