...
const UIUXHero = () => {
  return (
    <section className="bg-linear-to-b from-[#fcfbfb] to-[#FFEEC6] py-20">
      <div className="max-w-7xl mx-auto px-5 grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
        ...
        <div className=" h-full">
          ...
          <p className="text-gray-500 text-2xl  max-w-md leading-relaxed">
            <div className="font-semibold text-gray-700 ">The next big thing is the one that</div>
            makes the last big thing usable
          </p>

          <h1 className=" text-[120px] md:text-[120px] font-bold text-white/80 pointer-events-none select-none">
            Lets See
          </h1>
        </div>
