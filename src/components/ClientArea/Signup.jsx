            ...
            <div className="w-full   grid grid-cols-1 md:grid-cols-2 gap-10 gap-x-50 px-30">
                ...
                <div className="flex flex-col items-center ">
                    ...
                    <div className="w-full  bg-white rounded-xl shadow-[1px_2px_6px_gray] px-8 py-4">
                        ...
                        <Button className="w-full shadow-[1px_1px_8px_pink] text-xl  bg-[#FFE7B3] text-black py-3 rounded-lg font-semibold hover:bg-yellow-400 hover:text-white hover:-translate-1 hover:shadow-[2px_2px_6px_gray] cursor-pointer transition">
                            Continue
                        </Button>
                    </div>

                    <Button onClick={()=>{navigate("/user/signup")}}className="w-full text-center mt-6 shadow-[1px_1px_8px_pink] border border-gray-400 text-xl  bg-[#c5c5c5] text-black py-3 rounded-lg font-semibold hover:bg-gray-800 hover:text-white hover:-translate-1 hover:shadow-[3px_3px_4px_gray] cursor-pointer transition">
                   Login
                    </Button>
